    ...
    if (selectedChoice > 0 && selectedGender > 0 && selectedOrientation > 0) {
      dispatch(
        setSelectedPreferences({
          category: "Gender",
          preferences: data[selectedGender],
        })
      );
      dispatch(
        setSelectedPreferences({
          category: "SexualOrientation",
          preferences: data[selectedOrientation],
        })
      );
      dispatch(
        setSelectedPreferences({
          category: "GenderCriteria",
          preferences: data[selectedChoice],
        })
      );
      ...
      <ScrollView className="bg-white">
        <View className="p-4 mt-11">
            ...
            <View>
              ...
              >
                <View className="flex flex-row items-center ">
                  ...
                  <Text
                    className=" text-lg text-left mb-3 text-[#F21464] "
                    style={{ fontFamily: "mont-med" }}
                  >
                    ♂️{" "}
                  </Text>
            ...
            <View>
              ...
              >
                <View className="flex flex-row items-center ">
                  ...
                  <Text
                    className=" text-lg text-left mb-1 text-[#F21464] "
                    style={{ fontFamily: "mont-med" }}
                  >
                    {" "}
                  </Text>
          ...
          <View className="flex text-left px-[4%] pb-[5%] ">
            {hasError && (
              <Text className="flex text-center pt-[2%] text-red-500">
                {errorMessage}
              </Text>
            )}
